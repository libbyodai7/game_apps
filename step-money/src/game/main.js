...
var GameState = {
  ...
  create: function() {
    ...
    this.pet.customParams = {health: 100, money: 100};
   ...
   // this.pet.input.enableDrag();
    ...
    this.apple.customParams = {health: 20, money: -20};
    this.apple.inputEnabled = true;
    this.apple.events.onInputDown.add(this.pickItem, this);

    this.candy = this.game.add.sprite(144, 570, 'candy');
    this.candy.anchor.setTo(0.5);
    this.candy.customParams = {health: 10, money: -10};
    this.candy.inputEnabled = true;
    this.candy.events.onInputDown.add(this.pickItem, this);

    this.toy = this.game.add.sprite(216, 570, 'toy');
    this.toy.anchor.setTo(0.5);
    this.toy.customParams = {health: 30, money: -30};
    this.toy.inputEnabled = true;
    this.toy.events.onInputDown.add(this.pickItem, this);


    this.buttons = [this.apple, this.candy, this.toy];
    ...
    this.moneyText = this.game.add.text(210, 20, "", style);
    this.refreshStats();
